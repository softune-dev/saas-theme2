          ...
          {product.description || product.longDescription ? (
            <div className="space-y-4 text-left">
              ...
              {product.description?.includes("<") ? (
                <div
                  className="prose prose-sm mt-4 max-w-3xl text-[var(--muted-foreground)] [&_a]:text-[var(--brand)] [&_a]:underline [&_img]:my-4 [&_img]:rounded-lg [&_ol]:list-decimal [&_ol]:pl-5 [&_p]:mb-3 [&_ul]:list-disc [&_ul]:pl-5 [&_img[src*='s.w.org']]:float-left [&_img[src*='s.w.org']]:clear-left [&_img[src*='s.w.org']]:mt-0.5 [&_img[src*='s.w.org']]:mr-1.5 [&_img[src*='s.w.org']]:mb-1 [&_img[src*='s.w.org']]:h-4 [&_img[src*='s.w.org']]:w-4 [&_img[src*='s.w.org']]:rounded-none [&_li:has(p:empty)]:hidden"
